    ...
    boards: [
      {
        ...
        fields: [
          ...
          { key: 'descripcion', label: 'Descripción', col: 'D', type: 'textarea' },
    ...
    boards: [
      {
        ...
        fields: [
          ...
          { key: 'tema', label: 'Tema', col: 'B', type: 'textarea' },
          { key: 'autor', label: 'Autor', col: 'C', type: 'text' },
          { key: 'interes', label: 'Interés (0-10)', col: 'D', type: 'number', step: '0.5', min: 0, max: 10 },
          { key: 'enBiblioteca', label: 'En biblioteca', col: 'E', type: 'select', options: SI_NO, default: 'No' },
          { key: 'enEbook', label: 'En ebook', col: 'F', type: 'select', options: SI_NO, default: 'No' },
...
function buildFontaneriaModule() {
  return {
    id: 'fontaneria',
    title: 'Fontanería',
    subtitle: 'Manantial, depósito e instalación de la casa',
    icon: '🚰',
    custom: 'fontaneria',
